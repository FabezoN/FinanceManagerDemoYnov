...
public class DashboardController {
    ...
    private void loadBarChartData(LocalDate currentMonth) {
        ...
        List<Incomes> lastIncomes = IncomesDAO.findLastExpensesEndingAtCurrentMonth(12, currentMonth);
        for (Incomes income : lastIncomes) {
